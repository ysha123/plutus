...
data Binding tyname name uni a
  = TermBind a Strictness (VarDecl tyname name uni a) (Term tyname name uni a)
...
instance
  ...
  PrettyBy (PLC.PrettyConfigClassic configName) (VarDecl tyname name uni a)
  where
  prettyBy config (VarDecl _ n ty) = parens' ("vardecl" </> vsep' [prettyBy config n, prettyBy config ty])

instance
  (PLC.PrettyClassicBy configName tyname) =>
  PrettyBy (PLC.PrettyConfigClassic configName) (TyVarDecl tyname a)
  where
...
instance
  ...
  PrettyBy (PLC.PrettyConfigClassic configName) (Datatype tyname name uni a)
  where
  prettyBy config (Datatype _ ty tyvars destr constrs) =
    parens'
      ( "datatype"
          </> vsep'
            [ prettyBy config ty,
...
instance
  ...
  PrettyBy (PLC.PrettyConfigClassic configName) (Binding tyname name uni a)
  where
...
instance
  ...
  PrettyBy (PLC.PrettyConfigClassic configName) (Term tyname name uni a)
  where
  prettyBy config = \case
...
instance
  ...
  PrettyBy (PLC.PrettyConfigClassic configName) (Program tyname name uni a)
  where
...
instance
  ...
  Pretty (VarDecl tyname name uni a)
  where
  pretty = PLC.prettyClassicDef
...
instance
  ...
  Pretty (Datatype tyname name uni a)
  where
  pretty = PLC.prettyClassicDef
...
instance
  ...
  Pretty (Binding tyname name uni a)
  where
  pretty = PLC.prettyClassicDef
...
instance
  ...
  Pretty (Program tyname name uni a)
  where
  pretty = PLC.prettyClassicDef
