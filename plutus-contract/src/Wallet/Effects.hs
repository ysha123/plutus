...
data AddressChangeResponse = AddressChangeResponse
  { -- | The address
    acrAddress :: Address,
    -- | The slot
    acrSlot :: Slot,
    -- | Transactions that were validated in the slot and spent or produced at least one output at the address.
    acrTxns :: [Tx]
  }
...
data AddressChangeRequest = AddressChangeRequest
  { -- | The slot
    acreqSlot :: Slot,
    -- | The address
