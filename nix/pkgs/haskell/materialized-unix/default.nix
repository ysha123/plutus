  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "mmorph".revision = (((hackage."mmorph")."1.1.4").revisions).default;
        ...
        "http-conduit".revision = (((hackage."http-conduit")."2.3.7.4").revisions).default;
        ...
        "doctest".revision = (((hackage."doctest")."0.18").revisions).default;
        ...
        "sbv".revision = (((hackage."sbv")."8.10").revisions).default;
        ...
        "persistent".revision = (((hackage."persistent")."2.11.0.2").revisions).default;
